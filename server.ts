...
const GAMES = [
  ...
  { id: "2048", name: "2048", desc: "slide tiles, double them, chase 2048", icon: false },
  ...
  { id: "cubefield", name: "Cubefield", desc: "weave through an endless field of blocks", icon: false },
  { id: "cuttherope", name: "Cut the Rope", desc: "slice ropes to feed the little monster", icon: false },
  { id: "edgesurf", name: "Edge Surf", desc: "the surfing game hidden in edge", icon: false },
  { id: "getawayshootout", name: "Getaway Shootout", desc: "wobble to the escape, two players on one keyboard", icon: false },
  { id: "googlesnake", name: "Google Snake", desc: "the snake from the google doodle", icon: false },
  { id: "hextris", name: "Hextris", desc: "tetris, but it spins on a hexagon", icon: false },
  { id: "houseofhazards", name: "House of Hazards", desc: "booby-trap the house against your friends", icon: false },
  { id: "idlebreakout", name: "Idle Breakout", desc: "buy balls, break bricks, never stop", icon: false },
  { id: "minesweeper", name: "Minesweeper", desc: "flag the mines, don't click one", icon: false },
  { id: "pacman", name: "Pac-Man", desc: "eat the dots, dodge the ghosts", icon: false },
  { id: "paperio2", name: "Paper.io 2", desc: "claim territory without getting cut off", icon: false },
  { id: "rollyvortex", name: "Rolly Vortex", desc: "roll down a tunnel through the gaps", icon: false },
  { id: "rooftopsnipers", name: "Rooftop Snipers", desc: "one button, one roof, knock them off", icon: false },
  { id: "sandboxels", name: "Sandboxels", desc: "a falling-sand sandbox with hundreds of elements", icon: false },
  { id: "slope", name: "Slope", desc: "keep the ball on the neon track", icon: false },
  { id: "solitaire", name: "Solitaire", desc: "klondike, the one from every office computer", icon: false },
  { id: "stacktower", name: "Stack", desc: "time each block to build the tallest tower", icon: false },
  { id: "tetris", name: "Tetris", desc: "the original block puzzle", icon: false },
  { id: "thereisnogame", name: "There Is No Game", desc: "a game that insists it isn't one", icon: false },
  { id: "timeshooter3", name: "Time Shooter 3", desc: "time only moves when you do", icon: false },
  { id: "tinyfishing", name: "Tiny Fishing", desc: "cast deeper, upgrade, catch bigger fish", icon: false },
  { id: "tunnelrush", name: "Tunnel Rush", desc: "hurtle down a tunnel of obstacles", icon: false },
  { id: "worldshardestgame", name: "World's Hardest Game 2", desc: "it is not being modest", icon: false },
];
